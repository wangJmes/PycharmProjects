...
print(int(f1),type(int(f1)))# 将flot转成int类型，截取整数部分，舍掉小数部分
# print(int(s2),type(int(s2)))# 将str转成int类型，报错，因为字符串为小数串
print(int(ff),type(int(ff)))
#print(int(s3),type(int(s3))) # 将str转成int整型时，字符串必须是数字串（整数），非数字串是不允许转换


print('-----------float()将其它类型转化成float类型---')
s1='128.98'
s2='76'
ff=True
s3='hello'
